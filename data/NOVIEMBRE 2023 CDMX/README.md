# DENUE CDMX 11/2023 depurado para el Datatón 2026

## Qué contiene

- `denue_cdmx_11_2023_depurado.csv`: todos los campos originales más clasificación y controles de calidad, en UTF-8.
- `denue_cdmx_11_2023_depurado.geojson`: puntos listos para mapas web.
- `shapefile/denue_cdmx_11_2023_depurado.*`: capa SHP filtrada, con los campos originales y ocho campos derivados.
- `denue_cdmx_11_2023_depurado.xlsx`: vista de revisión, resumen y tabla analítica.
...
El archivo corresponde a la edición **DENUE 11/2023**, para la entidad **09, Ciudad de México**. Los metadatos indican modificación el **23 de noviembre de 2023**. Las fechas de marzo de 2024 del contenedor ZIP corresponden al empaquetado de algunos archivos, no a una nueva edición estadística.

## Regla de depuración

Se conservaron 3,224 de 475,331 registros (0.678%). Se eliminaron 472,107 registros cuyas actividades no miden la oferta elegida por el equipo.
...
- Registros con bandera de revisión: 132.
