# DENUE CDMX 05/2025 depurado para el Datatón 2026

## Qué contiene

- `denue_cdmx_05_2025_depurado.csv`: todos los campos originales más clasificación y controles de calidad, en UTF-8.
- `denue_cdmx_05_2025_depurado.geojson`: puntos listos para mapas web.
- `shapefile/denue_cdmx_05_2025_depurado.*`: capa SHP filtrada, con los campos originales y ocho campos derivados.
- `denue_cdmx_05_2025_depurado.xlsx`: vista de revisión, resumen y tabla analítica.
...
El archivo corresponde a la edición **DENUE 05/2025**, para la entidad **09, Ciudad de México**. Los metadatos indican modificación el **22 de mayo de 2025**. Las fechas de abril de 2026 del contenedor ZIP corresponden al empaquetado de los archivos, no a una nueva edición estadística.

## Regla de depuración

Se conservaron 3,194 de 460,762 registros (0.693%). Se eliminaron 457,568 registros cuyas actividades no miden la oferta elegida por el equipo.
...
- Registros con bandera de revisión: 125.
