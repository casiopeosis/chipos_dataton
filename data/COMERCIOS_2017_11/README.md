# DENUE Comercios CDMX 11/2017 depurado

## Qué contiene

Esta carpeta contiene una selección temática del DENUE 11/2017
para analizar acceso territorial a productos de primera necesidad
en la Ciudad de México.

Se conservaron 86,831 de 467,279
registros originales.

De los registros conservados:

- 80,354 corresponden a establecimientos de primera necesidad.
- 6,477 corresponden a oferta complementaria.
...
La edición DENUE 11/2017 utilizada no contiene el campo `CLEE`.
...
La fuente 11/2017 fue probada directamente antes de la depuración.
