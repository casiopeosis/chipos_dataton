# DENUE CDMX 11/2024 depurado para el Datatón 2026

## Qué contiene

- `denue_cdmx_11_2024_depurado.csv`: todos los campos originales más clasificación y controles de calidad, en UTF-8.
- `denue_cdmx_11_2024_depurado.geojson`: puntos listos para mapas web.
- `shapefile/denue_cdmx_11_2024_depurado.*`: capa SHP filtrada, con los campos originales y ocho campos derivados.
- `denue_cdmx_11_2024_depurado.xlsx`: vista de revisión, resumen y tabla analítica.
...
El archivo corresponde a la edición **DENUE 11/2024**, para la entidad **09, Ciudad de México**. Los metadatos indican modificación el **26 de noviembre de 2024**. Las fechas de abril de 2025 del contenedor ZIP corresponden al empaquetado de los archivos, no a una nueva edición estadística.

## Regla de depuración

Se conservaron 3,171 de 458,228 registros (0.692%). Se eliminaron 455,057 registros cuyas actividades no miden la oferta elegida por el equipo.
...
- Registros con bandera de revisión: 124.
