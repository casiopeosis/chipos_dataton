...
with st.sidebar:
    ...
    st.caption("Apoyo para priorizar inversión social en CDMX")
    st.markdown("---")
    ...
    categoria_sel = st.selectbox(
        ...
        index=0,
        help="Elige el servicio que quieres analizar.",
    )
    ...
    with st.expander("📖 ¿Qué significa cada color?", expanded=False):
        st.markdown("""
        - 🟢 **Oportunidad:** menor oferta relativa; conviene investigar.
        - 🟡 **Transición:** señal mixta; requiere seguimiento.
        - 🔴 **Saturada:** mayor oferta relativa o poco crecimiento.
        """)

    st.markdown("---")
    st.caption("📊 Las proyecciones incluyen incertidumbre para series pequeñas.")
...
<div class="fade-in" style="margin-bottom: 24px;">
    ...
    <p style="margin: 0; font-size: 1.05rem; color: #475569; max-width: 850px; line-height: 1.5;">
        Compara la oferta social entre alcaldías y muestra dónde conviene investigar primero.
    </p>
</div>
...
with tab_mapa:
    ...
    <div style="margin-bottom: 16px;">
        <h3 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: #0F172A;">
            Oportunidad social por territorio
        </h3>
        <p style="margin: 2px 0 0 0; font-size: 0.9rem; color: #64748B;">
            Selecciona un punto del mapa o una zona de la lista.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_priority:
        ...
        st.caption("Primero aparecen las de menor oferta relativa.")
...
with tab_simulador:
    ...
    <div style="margin-bottom: 16px;">
        ...
        <p style="margin: 2px 0 0 0; font-size: 0.9rem; color: #64748B;">
            Consulta la tendencia y su rango de incertidumbre.
        </p>
    </div>
    """, unsafe_allow_html=True)
...
with tab_matriz:
    ...
    <div style="margin-bottom: 16px;">
        <h3 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: #0F172A;">
            Cobertura frente a crecimiento
        </h3>
        <p style="margin: 2px 0 0 0; font-size: 0.9rem; color: #64748B;">
            Compara todas las alcaldías en una sola vista.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if not df_filtered.empty:
        ...
        with st.expander("📋 Ver indicadores", expanded=False):
            cols_clean = [
...
with tab_auditoria:
    ...
    <div style="margin-bottom: 16px;">
        ...
        <p style="margin: 2px 0 0 0; font-size: 0.9rem; color: #64748B;">
            Cómo se calculan y verifican las proyecciones.
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col_m1:
        st.markdown("#### 📐 Cálculo de incertidumbre")
        st.markdown("""
        La serie tiene cinco observaciones. Para evitar intervalos demasiado optimistas se usa:

        1. **t de Student con 3 grados de libertad**:
           $$t_{0.975,\\, 3} = 3.1824$$

        2. **Error de predicción completo**:
    ...
    with col_m2:
        ...
        st.markdown("""
        - **Entrenamiento:** ediciones 2022 a 2024.
        - **Prueba:** predicción de 2025 y 2026.
        - **LOO-CV:** mide la sensibilidad al retirar una observación.
        """)
    ...
    st.markdown("---")
    st.caption("""
    📌 **Fuentes:** DENUE 2022–2026 y Censo 2020, INEGI.
    """)
...
<div style="margin-top: 40px; padding-top: 16px; border-top: 1px solid #E2E8F0; text-align: center; font-size: 0.82rem; color: #94A3B8;">
    Semáforo de Inversión Social · Datatón CDMX 2026
</div>
""", unsafe_allow_html=True)
